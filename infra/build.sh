...
az deployment group create --location $FILES_RG_LOCATION --template-file ./src/private_endpoint_workflow.bicep --parameters ./output/private_endpoint_workflow.json